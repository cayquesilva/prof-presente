                            ...
                            <Dialog>
                                ...
                                <DialogContent className="p-0 gap-0 overflow-hidden sm:rounded-3xl border-none shadow-2xl max-w-[450px] w-full bg-white dark:bg-slate-900 mx-auto">
                                    <DialogHeader className="p-8 pb-4 bg-slate-50/50 dark:bg-slate-800/50">
                                        <DialogTitle className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Compartilhar Jornada</DialogTitle>
                                        <DialogDescription className="font-medium text-slate-600 dark:text-slate-400">
                                            Convide seus colegas para esta trilha de conhecimento.
                                        </DialogDescription>
                                    </DialogHeader>
                                    ...
                                    <div className="p-8 space-y-8 bg-white dark:bg-slate-900">
                                        <div className="grid grid-cols-4 gap-4">
                                            <Button 
                                                ...
                                                onClick={() => window.open(`https://api.whatsapp.com/send?text=Confira esta trilha de aprendizado: ${track?.title} ${window.location.href}`, '_blank')}
                                                title="WhatsApp"
                                            >
                                            ...
                                            <Button 
                                                ...
                                                onClick={() => window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(track?.title)}`, '_blank')}
                                                title="Twitter"
                                            >
                                        ...
                                        <div className="space-y-4">
                                            <Label className="font-bold text-slate-700 dark:text-slate-300 ml-1">Link da Trilha</Label>
